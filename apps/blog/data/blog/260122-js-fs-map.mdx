---
title: 'Iterable과 함께 사용하는 map 함수'
date: '2026-01-22'
tags: ['javascript', 'iterator', 'iterable', 'functional-programming', 'map']
draft: false
summary: 'JavaScript의 map 함수를 이해하고, Iterable 프로토콜을 활용하여 배열뿐만 아니라 Generator, Map 객체 등 다양한 데이터 구조를 변환하는 방법을 알아보자'
images:
...
const map = (f, iter) => {
  let res = []
  for (const a of iter) {  // for...of는 Iterable만 있으면 된다!
    res.push(f(a))
  }
  return res
}
