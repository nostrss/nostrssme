...
[Part 1](https://nostrss.me/blog/251117-audio-get-user-media)에서 `getUserMedia()`를 사용해 마이크 권한을 얻고 `MediaStream` 객체를 획득하는 방법을 다뤘다. 하지만 `MediaStream`만으로는 한계가 있다.
...
이제 [Part 1](https://nostrss.me/blog/251117-audio-get-user-media)에서 사용한 `getUserMedia()`와 Web Audio API를 결합해보자.
