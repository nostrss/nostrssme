...
`h-[calc(100svh-4rem)]`, `SidebarInset`의 `overflow-hidden`. 콘텐츠 전체가 viewport에 잠긴다. 대화 영역만 스크롤한다. 이건 **ChatGPT의 layout** — 그러나 페그보드 shadcn 토큰으로 그려진다 ([ADR-0007](/blog/260613-pegboard-05-pegman-retirement)). ChatGPT의 *palette/font를 가져온 게 아니다.*
